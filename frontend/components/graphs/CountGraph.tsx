                ...
                <div style={{display: "flex"}}>
                    <ResponsiveContainer width="100%" height={400} minWidth="0">
                        ...
                        >
                           ...
                           <Tooltip />
                           <Bar dataKey="commits" fill="#82ca9d" barSize={15} hide={!this.state.commitCheckboxChecked}/>
                           <Bar dataKey="mergeRequests" fill="#8884d8" barSize={15} hide={!this.state.mergeCheckboxChecked}/>
                        </BarChart>
                    </ResponsiveContainer>
                    <FormGroup>
                        <FormControlLabel
